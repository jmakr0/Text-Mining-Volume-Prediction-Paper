...
Compared to other approaches (\autoref{tbl:compare_approaches}), our $F_1$-score is $37\%$ higher than the  value by Tsagikas et al. and $8\%$ smaller than the values presented by Ambroselli et al. \cite{ambroselli2018prediction}.
