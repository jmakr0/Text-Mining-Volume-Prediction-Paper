...
Due to the English readership, \textit{The Guardian} releases its articles internationally which implies a much broader audience and discussed topics need to address this diversity.

is that the results we are comparing against 
...
was wäre nice
- mehr features
- abroselli unser dataset/ wir sein dataset